...
export default function HomeHeader() {
  ...
  // A drawer that scrolls the page behind it feels broken, and Escape should
  // always get you out.
  useEffect(() => {
    if (!open) return;
    ...
    <>
      ...
      <aside aria-label="Menu" className={styles.drawer} data-open={String(open)}>
        ...
        <div className={styles.drawerFoot}>
          <a href={`mailto:${contact.email}`} className={styles.drawerEmail}>
            {contact.email}
          </a>
